...
babylonInterop.createBox = function (name, width, height, depth, x, y, z) {
    const faceColors = [];
    //faceColors[0] = BABYLON.Color3.Yellow();
    ...
    var box = new BABYLON.MeshBuilder.CreateBox(name, { faceColors: faceColors, width: width, height: height, depth: depth })
    box.position.x = x;
    box.position.y = y;
    box.position.z = z;
